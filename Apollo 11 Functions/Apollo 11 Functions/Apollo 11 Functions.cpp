...
int main()
{
    ...
    // UNCOMMENT STUFF ABOVE THIS TESTING PART WHEN DONE
    cout << "What is your horizontal velocity (m/s)? 0" << endl;
    cout << "What is your vertical velocity (m/s)? -10.3" << endl;
    cout << "What is your altitude (m)? 58.2" << endl;
    cout << "What is your position (m)? 83" << endl;
    cout << "What is the angle of the LM where 0 is up (degrees)? -45" << endl;
    cout << "What is the time interval (s)? 1.5" << endl;
    double dx = 0;
    double dy = -10.3;
    double y = 58.2;
    double x = 83;
    ...
    /*
    Hint:   To accurately predict where the LM will be at the next unit of time, 
            first compute the acceleration, 
            then compute the new velocity, 
            and finally compute the new position.
    
    Hint:   The vertical component of the acceleration 
            includes both the acceleration due to thrust, 
    ...
    */
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        /*cout << "\n\naRadians " << aRadians;
        cout << "\naccelerationThrust " << accelerationThrust;
        cout << "\nddxThrust " << ddxThrust;
        cout << "\nddyThrust " << ddyThrust;
        cout << "\nddx " << ddx;
        cout << "\nddy " << ddy;
